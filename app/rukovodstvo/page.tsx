...
const jsonLd = {
  ...
  "@graph": [
    ...
    {
      "@type": "HowTo",
      "@id": `${BASE_URL}/rukovodstvo#howto`,
      "name": "Как рассчитать часовую ставку фрилансера",
      "description":
        "Пошаговый расчёт справедливой часовой ставки фрилансера с учётом налогов, отпуска и коэффициента загрузки.",
      "inLanguage": "ru",
      "totalTime": "PT7M",
      "tool": [
        {
      ...
      "step": [
        {
          "@type": "HowToStep",
          "position": 1,
          "name": "Определите желаемый чистый доход",
          "text":
            "Решите, сколько хотите получать после уплаты налогов каждый месяц. Эта сумма должна покрывать все расходы плюс накопления. Пример: 150 000 ₽/мес на руки.",
          "url": `${BASE_URL}/rukovodstvo#step1`,
        },
        {
          "@type": "HowToStep",
          "position": 2,
          "name": "Пересчитайте в gross с учётом налога",
          "text":
            "Налог платится с дохода до выплаты. Самозанятый (физлица, НПД 4%): Gross = 150 000 / (1 − 0.04) = 156 250 ₽/мес. Самозанятый (юрлица, НПД 6%): Gross = 150 000 / (1 − 0.06) = 159 574 ₽/мес.",
          "url": `${BASE_URL}/rukovodstvo#step2`,
        },
        {
          "@type": "HowToStep",
          "position": 3,
          "name": "Посчитайте оплачиваемые часы в год",
          "text":
            "От 260 рабочих дней (5 дней × 52 недели) вычтите отпуск (28 дней) и праздники (~14 дней) = 218 дней. Умножьте на загрузку 70% = 153 оплачиваемых дня. Умножьте на 8 часов = 1 224 оплачиваемых часа в год.",
          "url": `${BASE_URL}/rukovodstvo#step3`,
        },
        {
          "@type": "HowToStep",
          "position": 4,
          "name": "Рассчитайте часовую ставку",
          "text":
            "Разделите годовой gross на количество оплачиваемых часов. Годовой gross = 156 250 × 12 = 1 875 000 ₽. Часовая ставка = 1 875 000 / 1 224 ≈ 1 531 ₽/час. Итого: чтобы зарабатывать 150 000 ₽/мес чистыми при загрузке 70%, ставка должна быть ~1 530 ₽/час.",
          "url": `${BASE_URL}/rukovodstvo#step4`,
        },
      ],
    },
    {
      ...
      <main className="max-w-2xl mx-auto px-4 py-10">
        ...
        <article className="prose-custom">
          ...
          <Section>
            ...
            <H3 id="step1">Шаг 1. Определите желаемый чистый доход</H3>
            <P>
            ...
            <H3 id="step2">Шаг 2. Пересчитайте в gross с учётом налога</H3>
            <P>
...
Gross = 150 000 / (1 − 0.06) = 159 574 ₽/мес`}
            ...
            <H3 id="step3">Шаг 3. Посчитайте оплачиваемые часы в год</H3>
            <P>
...
Часов: 153 × 8 = 1 224 оплачиваемых часа`}
            ...
            <H3 id="step4">Шаг 4. Рассчитайте часовую ставку</H3>
            <CodeBlock>
...
function H3({ children, id }: { children: React.ReactNode; id?: string }) {
  return (
    <h3 id={id} className="text-base font-semibold text-slate-800 mt-5 mb-1">{children}</h3>
  );
}
