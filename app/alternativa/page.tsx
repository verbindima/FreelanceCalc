...
const competitors = [
  ...
  {
    slug: "moj-nalog-kalkulator",
    name: "«Мой налог»",
    url: "lknpd.nalog.ru",
    description: "Официальное приложение ФНС для самозанятых. Регистрирует доходы и считает НПД, но не помогает рассчитать правильную ставку с учётом загрузки и отпуска.",
