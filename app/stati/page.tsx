...
const ARTICLES = [
  ...
  {
    slug: "kak-vystavit-schet-samozanyatomu-2026",
    title: "Как выставить счёт самозанятому клиенту в 2026 году",
    description: "Самозанятые не выставляют «счёт» — они формируют чек. Пошаговая инструкция: как оформить чек для физлица и юрлица, предоплата, сроки, штрафы за нарушения.",
    readTime: "6 мин",
    tag: "Самозанятость",
  },
  {
  ...
  },
  {
    ...
    description:
      "Иностранные клиенты платят в 2–4 раза больше. Самозанятый может работать с ними законно — НПД 6%. Как получить оплату, какой договор, как рассчитать ставку в долларах с учётом курса.",
    readTime: "9 мин",
    tag: "Международное",
  },
  {
  ...
  },
  {
    ...
    title: "Налоговый вычет для самозанятых 2026: как получить бонус 10 000 ₽",
    description:
      "Каждый самозанятый получает вычет 10 000 ₽ при регистрации автоматически. Ставка НПД временно снижается с 4% до 3%. Как работает, сколько экономишь и как не потерять при перерегистрации.",
    readTime: "6 мин",
    tag: "Налоги",
  },
  {
  ...
  {
    slug: "kredit-dlya-samozanyatogo-2026",
    title: "Кредит для самозанятого 2026: какие банки дают и как подтвердить доход",
    description:
      "Сбер, Т-Банк, ВТБ, Альфа-Банк дают кредиты самозанятым. Главное — справка из «Мой налог» и стабильные чеки за 12 месяцев. Условия, ставки, что делать при отказе.",
    readTime: "8 мин",
    tag: "Самозанятость",
  },
  {
    ...
    description:
      "Сбер, ВТБ, Т-Банк, Совкомбанк дают ипотеку самозанятым. Главное — правильно подтвердить доход через «Мой налог». Полный гид: условия, справка КНД 1122036, чек-лист.",
    readTime: "8 мин",
    tag: "Самозанятость",
  },
  {
    ...
    description:
      "Самозанятые по умолчанию не платят пенсионные взносы — каждый год без взносов теряется из стажа навсегда. Добровольные взносы в СФР, расчёт стоимости, сравнение стратегий накопления.",
    readTime: "9 мин",
    tag: "Самозанятость",
  },
  {
