...
export const metadata: Metadata = {
  ...
  description:
    "Не знаете медианную ставку в своём городе? Скорее всего, уже работаете дешевле рынка. 32 специальности × 10 городов × Junior/Mid/Senior. Данные Q2 2026 + новые AI-специальности. PDF за 249 ₽.",
  keywords: [
  ...
  openGraph: {
    title: "Рыночные ставки фрилансеров по городам России — Q2 2026",
    description:
      "Работаете дешевле рынка? Проверьте — медианные ставки 32 специальностей в 10 городах. Москва, СПб, регионы. Junior/Mid/Senior. Новое: AI/Prompt-инженер. PDF Q2 2026 за 249 ₽.",
    type: "website",
    locale: "ru_RU",
  ...
  "@graph": [
    {
      ...
      name: "PDF «Рыночные ставки фрилансеров» Q2 2026",
      description:
        "Медианные ставки по 32 специальностям и 10 городам России. Данные за Q2 2026. Новая категория: AI/ИИ (Prompt-инженер, AI-агент разработчик). Разбивка по уровням опыта (джун / мид / сеньор).",
      url: `${BASE_URL}/benchmark`,
      offers: {
        "@type": "Offer",
        price: "249",
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "PDF содержит таблицу медианных часовых ставок по 32 специальностям (AI/ИИ, разработка, дизайн, маркетинг, тексты) в 10 городах России: Москва, Санкт-Петербург, Новосибирск, Екатеринбург, Казань, Краснодар, Нижний Новгород, Ростов-на-Дону, Самара, Уфа. Данные актуальны на Q2 2026.",
          },
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Бенчмарк обновляется ежеквартально. Текущая версия — Q2 2026 (апрель 2026). Добавлены AI-специальности.",
          },
        },
      ],
    },
...
const PREVIEW_ROWS = [
  { specialty: "AI-агент разработчик", category: "AI/ИИ", msk: "3 500–5 800 ₽/ч", spb: "2 900–4 800 ₽/ч" },
  { specialty: "Prompt-инженер", category: "AI/ИИ", msk: "1 900–3 100 ₽/ч", spb: "1 600–2 600 ₽/ч" },
...
const categoryColor: Record<string, string> = {
  "AI/ИИ":     "text-cyan-600 bg-cyan-50",
        ...
        <main className="max-w-5xl mx-auto px-4 py-8 md:py-12">
          ...
          <div className="mb-8 md:mb-10">
            ...
            <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
              ...
              Реальные ставки по <strong>32 специальностям</strong> в <strong>10 городах</strong> России. Джун / мид / сеньор. <span className="text-cyan-600 font-semibold">Новое: AI/ИИ специалисты.</span>
            </p>
          </div>
              ...
              {[
                {
                  ...
                  a: "Таблицу медианных часовых ставок по 32 специальностям (включая новую категорию AI/ИИ) в 10 городах России с разбивкой по уровням опыта (джун / мид / сеньор). Данные актуальны на Q2 2026.",
                },
                {
                ...
                },
                {
                  ...
                  a: "Ежеквартально. Текущая версия — Q2 2026 (апрель 2026). Q3 2026 выйдет в сентябре 2026.",
                },
              ].map((item) => (
