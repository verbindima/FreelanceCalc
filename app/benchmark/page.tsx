...
export const metadata: Metadata = {
  ...
  description:
    "Не знаете медианную ставку в своём городе? Скорее всего, уже работаете дешевле рынка. 22 специальности × 10 городов × Junior/Mid/Senior. Данные Q1 2026. PDF за 249 ₽.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Работаете дешевле рынка? Проверьте — медианные ставки 22 специальностей в 10 городах. Москва, СПб, регионы. Junior/Mid/Senior. PDF Q1 2026 за 249 ₽.",
    type: "website",
    locale: "ru_RU",
        ...
        <main className="max-w-5xl mx-auto px-4 py-8 md:py-12">
          ...
          <section className="mb-10 bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-2xl p-6 md:p-10 text-white text-center">
            ...
            <p className="text-indigo-100 mb-2 max-w-lg mx-auto text-sm md:text-base leading-relaxed">
              ...
              Единоразовый платёж — PDF мгновенно после оплаты. Оплата через ЮKassa (карты РФ, СБП).
            </p>
